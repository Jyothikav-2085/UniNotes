  ...
  return (
    <>
      ...
      <div className={`PasswordOtpwrapper`}>
        {/* Circles */}
        <div className={`circleBG PasswordOtpleftCircle ${animate ? 'circleIn' : ''}`}></div>
        <div className={`circleBG PasswordOtprightCircle ${animate ? 'circleIn' : ''}`}></div>
        {/* Panels */}
        <div className={`PasswordOtpleftPanel ${animate ? 'fadeSlideIn' : ''}`}>
          <img
            className="PasswordOtpillustration"
            src="/PasswordVerificationIllustration.png"
        ...
        <div className={`PasswordOtprightPanel ${animate ? 'fadeSlideIn' : ''}`}>
